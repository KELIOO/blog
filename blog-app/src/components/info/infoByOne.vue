<!--
<template>
  &lt;!&ndash; 6.定义一个点击事件&ndash;&gt;
  <button @click="handleClick('父组件')">点击</button>
  &lt;!&ndash; 3.在页面中使用dialog-component组件&ndash;&gt;
  &lt;!&ndash; 4.设置v-if语句，通过动态改变Visiable值用来控制弹窗是否弹出&ndash;&gt;
  &lt;!&ndash; 5.设置ref属性，相当于唯一标识dialog-component组件&ndash;&gt;
